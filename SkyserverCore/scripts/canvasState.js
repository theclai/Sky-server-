...
CanvasState.prototype.showNearest = function (raDec) {
    ...
    let infoURL = "http://test.preprod.skyserver.sdss.org/dr15/SkyServerWS/SearchTools/MetadataSearch?query=nearestobj&" + selectedobj;
   ...
   $.when(fillPromise).done(
       function getSpecObjId(data) {
           ...
           const specUrl = "http://test.preprod.skyserver.sdss.org/dr16/SkyServerWS/SearchTools/MetadataSearch?query=nearestspecobjid&objid=" + objId;
